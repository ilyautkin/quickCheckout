...
class quickCheckoutHomeManagerController extends quickCheckoutMainController {
	...
	public function loadCustomCssJs() {
        ...
        $this->addJavascript($this->quickCheckout->config['jsUrl'] . 'mgr/widgets/status.grid.js');
        ...
        $this->addJavascript($this->quickCheckout->config['jsUrl'] . 'mgr/quickcheckout.combo.js');
