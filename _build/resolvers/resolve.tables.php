...
if ($object->xpdo) {
    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            $modelPath = $modx->getOption('quickcheckout_core_path', null, $modx->getOption('core_path') . 'components/quickcheckout/') . 'model/';
            $modx->addPackage('quickcheckout', $modelPath);

            $manager = $modx->getManager();
            $objects = array();
            $schemaFile = MODX_CORE_PATH . 'components/quickcheckout/model/schema/quickcheckout.mysql.schema.xml';
